...
// Array utils
    ...
    type TEXT_ALIGNMENT_LEFT = number
    /**
    ...
    type TEXT_ALIGNMENT_CENTER = number
    /**
    ...
    type TEXT_ALIGNMENT_RIGHT = number
    /**
     * text alignment : top
     * @constant
     * @type Number
    ...
    type VERTICAL_TEXT_ALIGNMENT_TOP = number
    /**
     * text alignment : center
     * @constant
     * @type Number
    ...
    type VERTICAL_TEXT_ALIGNMENT_CENTER = number
    ...
    type VERTICAL_TEXT_ALIGNMENT_BOTTOM = number
    //+---------- Function definitions ----------+//
    /**
     * @function
