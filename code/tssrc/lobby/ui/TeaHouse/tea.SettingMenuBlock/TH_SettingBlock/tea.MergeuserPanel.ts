...
//     //     }
//     //     zOrder: number = null;
//     //     __selfPanel: MergeUserPanel = null;
...
//     //             this.__selfPanel = new MergeUserPanel();
...
//     class MergeUserPanel extends kaayou.Layer{
...
//         initUI(){
//             this.initWithccs(res.TH_MergeUserPanel_json);
            
//             this.tab_listview = ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "tab_listview");
//             this.tab1 =  ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "tab1");
//             this.tab2 =  ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "tab2");

//             this.jl_item = ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "jl_item");
//             this.hq_panel = ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "hq_panel");
//             this.jl_panel = ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "jl_panel");
//             this.btn_close= ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "btn_close");
//             this.content = ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "content");
...
//             let label:ccui.Text = ccui.helper.seekWidgetByName(<ccui.Widget>node, "text");
//             label.setColor(cc.color(toggle?"#975638":"#FEF0E2"));
//             node.loadTexture(toggle?"btn_MergeUserTab_check.png":"btn_MergeUserTab_uncheck.png", ccui.Widget.PLIST_TEXTURE);
//         }
...
//         // @BindEvent('tea',"ui::mergeUserPanel::gethqrecord")
...
//         //收到合圈请求
//         // @BindEvent("lobby","ws::Msg::housemerge_ntf")
        

//         //收到合圈请求结果
//         // @BindEvent("lobby","ws::Msg::housemergersp_ntf")
...
//         //掀桌子
//         // @BindEvent("tea","ui::mregeUserPanel::houserevokereq")
...
//         private setBG(i){
//             this.bg.loadTexture((i%2)?"item_MergeUser_bg1.png":"item_MergeUser_bg2.png",ccui.Widget.PLIST_TEXTURE)
//         }
