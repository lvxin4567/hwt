...
namespace tea {
    ...
    export class Pm_subMemberPanel {
        ...
        reset(){
            ...
            let timeChangeEventName = "ui::memPm::time::change";
           this.resetTimeLine(); 
        ...
        initWithNode(pageMine: cc.Node, searchMgr: MemSearchWidget, cellMod: ccui.Widget) {
            ...
            kaayou.getController('tea').on('ui::TimeMatch::memRank', function (e: kaayou.Event) {
        ...
        async pullList(clear: boolean = true, timetype: number = -1) {
           ...
           kaayou.emit("tea", 'mod::House::GetTMmineRank',{dfid:-1,param:search,daytype:this.timeType,sorttype:4,clear:clear});
        }
