...
namespace tea {
    ...
    class TH_RC_GameNumberCell extends kaayou.Block implements common.IPullListCell {
        constructor() {
            super();
        }
        _index = -1;
        ...
        initWithNode(node: ccui.Widget) {
            ...
            this.btn_detail = ccui.helper.seekWidgetByName(<ccui.Widget>this.node, "GameNumberRowClear");
                    ...
                    btns: [
                        {
                            ...
                            action: function () {
                                kaayou.SoundManager.getInstance().playSound(common.SoundRes.ClickBtnDefault);
                                kaayou.emit("tea", "mod::Record::ClearGameNumber", {
        ...
        setInfo(data) {
            ...
            this.label_winner.setString("对局次数：" + this._data.recordtimes.toString());
    ...
    export class SubRcGameNumberPage {
        ...
        initWidthNode(page: cc.Node, searchMgr: RecordSearchWidget, selecthMgr: RecordSelectWidget, cellMod: ccui.Widget, clearButton: ccui.Button) {
            ...
            this.scr_business.setAdpter({
                getCell: () => {
                    let v = new TH_RC_GameNumberCell();
